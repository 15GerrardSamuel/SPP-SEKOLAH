...
<div class="main-content mb-1">
	...
	<div class="content-header mr-2">
		 <div class="row mb-2">
          <div class="col-sm-6">
           <h3 class="col-sm-6 ml-5">Data Kelas</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="modal-body">
      <form action="" method="POST" enctype="multipart/form-data">
        <div class="form-group">
          <label>Kelas</label>
          <input type="text" class="form-control" autocomplete="off" name="kelas">
        </div>
...
<div class="row">
 <div class="table-responsive table--no-card m-b-30 ml-5 mr-5">
    ...
    <center><ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" <?php if($halaman > 1){ echo "href='?m=kelas&halaman=$previous'"; } ?>>Previous</a>
                </li>
                <?php 
                for($x=1;$x<=$total_halaman;$x++){
                    ?> 
                    <li class="page-item"><a class="page-link" href="?m=kelas&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                    <?php
                }
                ?>              
                <li class="page-item">
                    <a  class="page-link" <?php if($halaman < $total_halaman) { echo "href='?m=kelas&halaman=$next'"; } ?>>Next</a>
                </li>
            </ul>
              </center> 
