...
<div class="main-content mb-1">
	...
	<div class="content-header mr-2">
		 <div class="row mb-2">
          <div class="col-sm-6">
           <h3 class="col-sm-6 ml-5">Data Tahun Pelajaran</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="row">
 <div class="table-responsive table--no-card m-b-30 ml-5 mr-5">
    ...
    <center><ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" <?php if($halaman > 1){ echo "href='?m=tapel&halaman=$previous'"; } ?>>Previous</a>
                </li>
                <?php 
                ...
                ?>              
                <li class="page-item">
                    <a  class="page-link" <?php if($halaman < $total_halaman) { echo "href='?m=tapel&halaman=$next'"; } ?>>Next</a>
                </li>
            </ul>
              </center> 
